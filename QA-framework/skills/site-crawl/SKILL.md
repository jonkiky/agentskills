...
argument-hint: 'Start URL and optional max-pages/concurrency (example: https://example.com --max-pages 500 --concurrency 2)'
user-invocable: true
---
...
2. Run crawler:
  - `node ./.github/skills/site-crawl/scripts/crawl-urls.mjs <start-url> --max-pages <N> --concurrency <N>`
  - If user input is missing, run:
    - `node ./.github/skills/site-crawl/scripts/crawl-urls.mjs https://example.com --max-pages 1000 --concurrency 2`
3. Collect generated files:
   - `sitemap-YYYYMMDD-HHMMSS.json`
   - `sitemap-YYYYMMDD-HHMMSS.txt`
   - `crawl-report-YYYYMMDD-HHMMSS.json`
