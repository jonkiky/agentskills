...
2. Run comparison:
  - `node ./.github/skills/image-comparison/scripts/compare-images.mjs <folderA> <folderB> <report.json>`
  - If user input is missing, run:
    - `node ./.github/skills/image-comparison/scripts/compare-images.mjs images images2 report.json`
